...
const PRESETS: Preset[] = [
  { key: '1',
    ...
    prompt: '今の日経225先物のトレンド方向と上値/下値のメドを、マークダウンの見出し(#)や太字(**)を使わずプレーンテキストで、次の形式で簡潔に答えて。\n1行目「短期的な○○トレンドにあると推察」(○○は上昇/下降/レンジ)。\n2行目以降、根拠を「*」始まりの箇条書き(現値と1時間高値・安値の位置関係 / 短期5分平均と長期60分平均の位置 / 15分変化率)。\n次の行に「上値メド」とだけ書き、その下に「*価格付近:理由」の箇条書き。\n次の行に「下値メド」とだけ書き、その下に「*価格付近:理由」の箇条書き。\n数字は与えられたテクニカル要約から具体的に引用。' },
  { key: '2',
    label: '急変の理由を詳しく',
