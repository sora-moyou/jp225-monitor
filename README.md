...
JP225 の価格変動をリアルタイムに監視し、30 秒間および 5 分間の急変動を感知し、AI がその原因を考察する Windows デスクトップアプリです。疑問点は、AI とチャット可能です。
...
**👉 [利用マニュアル (HTML、見やすい版)](https://htmlpreview.github.io/?https://github.com/sora-moyou/jp225-monitor/blob/master/docs/USER_GUIDE.html)**
