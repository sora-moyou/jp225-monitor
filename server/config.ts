...
- 価格アクション（OHLC・レンジ）から「下髭/上髭/サポート反転/レジスタンス・ブレイク」等を読み取れる場合は、ファンダ材料の後に簡潔に併記する。`;

// LLM プロバイダ: Gemini 2.5 Flash Lite（無料、Thinking OFF デフォルト、出力切れない）
// 切替候補:
//   - Gemini Flash (品質↑ Thinking分の出力切れ注意): model='gemini-2.5-flash'
//   - Gemini Pro:   model='gemini-2.5-pro' (より高品質、無料枠厳しい)
//   - Gemini 2.0 Flash: model='gemini-2.0-flash' (旧モデル、Thinkingなし)
//   - Groq:   baseURL='https://api.groq.com/openai/v1', model='llama-3.3-70b-versatile'
//   - OpenAI: baseURL=undefined, model='gpt-4o-mini'
export const LLM_BASE_URL: string | undefined = 'https://generativelanguage.googleapis.com/v1beta/openai/';
export const LLM_MODEL = 'gemini-2.5-flash-lite';
// チャットだけ Thinking 有効（しっかり推論、回答は遅め＆トークン消費大）
// 切替: 'gemini-2.5-flash' (Thinking on)、'gemini-2.5-pro' (Thinking 常時 on、最高品質)
export const LLM_CHAT_MODEL = 'gemini-2.5-flash';
